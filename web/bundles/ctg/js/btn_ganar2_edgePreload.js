...
if(document.addEventListener ){ 
   ...
   aLoader = [
    { load: "/web/bundles/ctg/js/edge_includes/jquery-1.7.1.min.js"},
    { load: "/web/bundles/ctg/js/edge_includes/edge.2.0.1.min.js"},
          { load: "/web/bundles/ctg/js/btn_ganar2_edge.js"},
          { load: "/web/bundles/ctg/js/btn_ganar2_edgeActions.js"}];
